...
namespace Jambo.IoC
{
    public class ConsumerServiceBusModule : Module
    {
        private readonly string _connectionString;
        private readonly string _topic;
        private readonly ProcessDomainEventDelegate _proccessDomainEvent;

        public ConsumerServiceBusModule(string connectionString, string topic, ProcessDomainEventDelegate proccessDomainEvent)
        {
