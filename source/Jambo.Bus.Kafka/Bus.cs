...
namespace Jambo.Bus.Kafka
{
    public class Bus : IBusReader, IBusWriter
    {
        ...
        private EventReceivedDelegate onReceive;
        public EventReceivedDelegate OnEventReceived {
            get => onReceive;
            set => onReceive = value; }

        public Bus(string brokerList, string topicName)
        {
